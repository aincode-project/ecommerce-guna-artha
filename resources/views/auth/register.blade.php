                        ...
                        <div class="login_wrap widget-taber-content background-white">
                            <div class="padding_eight_all bg-white">
                                ...
                                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <select class=" form-control" style="color: gray" id="jenis_kelamin" name="jenis_kelamin" aria-label="Default select example">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="image" type="file" style="padding-top: 20px" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" onchange="previewImage()">
                                        @error('image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
