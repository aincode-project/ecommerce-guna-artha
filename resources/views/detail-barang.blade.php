            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul>
                        ...
                        <li><a href="#" style="pointer-events: none">product details</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-5 col-lg-5">
                    <div id="sticky_pro_zoom">
                        <ul class='exzoom_img_ul'>
                            <li><img class="zoom ing-fluid w-100" src="{{ asset('storage/' . $dataBarang->foto_barang) }}" alt="product"></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-5 col-md-7 col-lg-7">
                    <div class="wsus__pro_details_text">
                        ...
                        @else
                        <p class="wsus__stock_area"><span class="in_stock">Stok Tersedia</span> ({{ $dataBarang->total_stok }} item)</p>
                        @endif
                        <h4>@currency($dataBarang->harga_jual)</h4>
                        <div class="wsus__quentity">
                            ...
                            <form action="{{ route('keranjang.store') }}" method="post" class="select_number">
                                ...
                                @if ($dataBarang->total_stok == 0)
                                <input class="number_area" type="text" name="jumlah" min="1" max="{{ $dataBarang->total_stok }}" value="0" />
                                @else
                                <input class="number_area" type="text" name="jumlah" min="1" max="{{ $dataBarang->total_stok }}" value="1" />
                                @endif
                        </div>
                        ...
                        <p class="brand_model"><span>kategori :</span> {{ $dataBarang->kategori_barang->nama_kategori }}</p><br>
                        @auth
