                            ...
                            <tbody>
                                ...
                                <tr class="d-flex">
                                    <td class="wsus__pro_img">
                                        <img src="{{ asset('storage/' . $dataKeranjang->barang->foto_barang) }}" alt="product"
                                            class="img-fluid w-100">
                                    </td>

                                    <td class="wsus__pro_name">
                                        <p>{{ $dataKeranjang->barang->nama_barang }}</p>
                                        <span>Kategori: {{ $dataKeranjang->barang->kategori_barang->nama_kategori }}</span>
                                        <span>Stok: {{ $dataKeranjang->barang->total_stok }}</span>
                                    </td>

                                    <td class="wsus__pro_status">
                                        <h6>@currency($dataKeranjang->barang->harga_jual)</h6>
                                    </td>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="wsus__pro_select">
                                                                                ...
                                                                                <div class="select_number">
                                                                                    <input class="number_area" name="jumlahBaru" type="text" min="1" max="{{ $dataKeranjang->barang->total_stok }}" value="{{ $dataKeranjang->jumlah }}" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xl-12">
                                    ...
                                    <td class="wsus__pro_tk">
                                        <h6>@currency($dataKeranjang->barang->harga_jual * $dataKeranjang->jumlah)</h6>
                                    </td>
